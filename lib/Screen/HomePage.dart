...
class _HomePageState extends State<HomePage>
                        ...
                        child: Container(
                          ...
                          child: Row(children: [
                            Padding(
                              ...
                              child: Icon(Icons.search,color: colors.blackTemp,size: 30,),
                            ),
                            SizedBox(width: 10,),
                            Text("Search For Product,Brands And More")
                          ],),
  ...
  _Text(){
    return Padding(
      ...
      child: Text('Categories',style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 20),),
    );
  }
        ...
        return data
            ...
            : Container(
                ...
                child: GridView.builder(
                  physics: NeverScrollableScrollPhysics(),
                  itemCount: catList.length < 9 ? catList.length : 9,
       ...
       child: Container(
          ...
          decoration: BoxDecoration(
            color: colors.secondary,
              borderRadius: BorderRadius.circular(10)),
          child: Center(child: Text('View More',style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),)),
        ),
     ),
   );
  }
